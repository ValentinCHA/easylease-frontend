...
>>>>>>> 9068ccdef19bb80f577a65d6ca52cf50cc4a43c5
      ...
      <div className={styles.pourcentageDiag}>
        <div className={styles.left}>
          <span className={styles.pourcentage}>La marge réalisée est de : {(100 * margeRea/objMarge).toFixed(2)}% sur l'objectif total</span>
        </div>
        <div className={styles.right}>
          <span className={styles.pourcentage}>Le CA réalisée est de : {(100 * CArealise/objCA).toFixed(2)}% sur l'objectif total</span>
        </div>
      </div>
    </div>
    </div>
